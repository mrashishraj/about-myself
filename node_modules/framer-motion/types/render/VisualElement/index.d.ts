...
import { VisualElementConfig, ResolvedValues } from "framer-motion/types/render/VisualElement/types";
import { AxisBox2D } from "framer-motion/types/types/geometry";
import { Snapshot } from "framer-motion/types/components/AnimateSharedLayout/utils/stack";
import { Target, TargetAndTransition, Variants } from "framer-motion/types/types";
import { startAnimation } from "framer-motion/types/animation/utils/transitions";
import { AnimationState } from "framer-motion/types/render/VisualElement/utils/animation-state";
