...
import { SharedLayoutProps } from "framer-motion/types/components/AnimateSharedLayout/types";
import { LayoutStack } from "framer-motion/types/components/AnimateSharedLayout/utils/stack";
import { HTMLVisualElement } from "framer-motion/types/render/dom/HTMLVisualElement";
import { SharedLayoutSyncMethods } from "framer-motion/types/components/AnimateSharedLayout/SharedLayoutContext";
/**
 * @public
 */
export declare class AnimateSharedLayout extends React.Component<SharedLayoutProps> {
    static contextType: React.Context<import("framer-motion/types/motion/context/MotionContext").MotionContextProps>;
    /**
